...
public class OrderApplicationImpl implements OrderApplication {
    ...
    public void createOrder(OrderDto orderDto) throws Exception {
        ...
        order.setStartOrderLocation(this.getOrderLocationFromOrderLocationDto(orderDto.getStart()));
        order.setEndOrderLocation(this.getOrderLocationFromOrderLocationDto(orderDto.getEnd()));
